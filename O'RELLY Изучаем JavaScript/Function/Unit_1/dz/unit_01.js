...
let input_5 = document.querySelector(".i-5");
function odd() {
...
function t7() {
    out7.textContent = (z7 === 100) ? z7 = 100 : ++z7;
...
// Task 10
// Напишите функцию, которая перебирает массив ar10 в ar10_res записывает только числа из ar10. В конце функции t10 для вывода массива запустите функцию showArr.
...
function t10() {
    ...
    for (let i = 0; i < ar10.length; i++) {
        if (typeof ar10[i] === "number") ar10_res.push(ar10[i]);
        console.log(ar10_res);
    }
    showArr();
}
