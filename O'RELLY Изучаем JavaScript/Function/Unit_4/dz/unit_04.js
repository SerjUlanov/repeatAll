...
document.querySelector('.b-12').addEventListener('click', function () {
    document.querySelector('.out-12').textContent = t12(111, 22);
})
...
const t14 = str => str.trim() !== "" ? str.trim() : false
...
const t15 = str => str !== Number(str) ? false : true;
...
document.querySelector('.b-16').addEventListener('click', function () {
    document.querySelector('.out-16').textContent = t16([4, 5, 6, 7]);
})
...
document.querySelector('.b-17').addEventListener('click', function () {
    document.querySelector('.out-17').textContent = t17([4, 5, 6, "fga"]);
})
...
const t18 = (arr, item) => arr.includes(item) ? true : false
...
const t19 = (word, boolen) => boolen === true ? word.split("").reverse().join("") : word;
...
const t20 = (obj, x) => Object.keys(obj).find(key => obj[key] === x)
