...
function t4() {
    let r = document.querySelectorAll(".r-4");
...
function t5() {
    const s5_1 = Number(document.querySelector(".s51").value);
    const s5_3 = Number(document.querySelector(".s53").value);
    const s5_2 = document.querySelector(".s52").value;

    switch (s5_2) {
        case "-": return s5_1 - s5_3
        case "+": return s5_1 + s5_3
        case "*": return s5_1 * s5_3
        case "/": return s5_1 / s5_3
    }
...
document.querySelector('.b-7').addEventListener('click', function () {
    document.querySelector('.out-7').textContent = t7(61);
})
...
document.querySelector('.b-9').addEventListener('click', function () {
    document.querySelector('.out-9').textContent = t9(7, 2);
})
...
document.querySelector('.b-11').addEventListener('click', function () {
    document.querySelector('.out-11').textContent = t11(33, 22, 44, 11, 55, 66, 11, 68);
})
...
document.querySelector('.b-12').addEventListener('click', function () {
    document.querySelector('.out-12').textContent = t12(33, 22, 44, 11, 55, 66, 11, 615);
})
...
function t17() {
    let select = document.querySelector(".s-171").value;
    return select;
}
...
function t20(s) {
    ...
    // }
    // console.log(rev);
    //третий метод рекусия
    // if (s === "") return "";
    // else return t20(s.substring(1)) + s.charAt(0);
}
